...
Vagrant.configure(2) do |config|
  ...
  (1..LOAD_BALANCER_COUNT).each do |i|
    ...
    config.vm.define "loadbalancer#{i}" do |lb|
      ...
      lb.vm.network "public_network", dev: "bridge0", mode: "bridge",  type: "bridge", mac: "080021#{i}#{i}#{i}#{i}#{i}#{i}"
  ...
  (1..CONTROL_PLANE_COUNT).each do |i|
    ...
    config.vm.define "kcontrolplane#{i}" do |cpnode|
      ...
      cpnode.vm.network "public_network", dev: "bridge0", mode: "bridge",  type: "bridge", mac: "080023#{i}#{i}#{i}#{i}#{i}#{i}"
  ...
  (1..WORKER_COUNT).each do |i|
    ...
    config.vm.define "kworker#{i}" do |workernode|
      ...
      workernode.vm.network "public_network", dev: "bridge0", mode: "bridge",  type: "bridge", mac: "080025#{i}#{i}#{i}#{i}#{i}#{i}"
